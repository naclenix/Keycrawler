...
+ "\nCommands are: 'go east'; 'go north'; 'go south'; 'go west'; 'go back'; 'get
[item]'; and 'use [item]'."
+ "\nThe command 'go back' returns you to the center. No matter what, you are
always facing north."
...
+ "\nThis room is red and seems very bare-bones, just a cube. The white door
locks behind you."
+ "\nOn the east wall, you see a locked chest. You'd bet your left arm that it
contains something."
...
+ "\nIt has a five-letter combination lock on it."
+ "\nThe words 'A SHINY RED FRUIT' are written on its top."
+ "\nYou'll have to enter something into the lock to open it.");
command = scanner.nextLine();
...
+ "\nInside, on a velvet cushion, is a single copper key engraved with the letter
E.");
command = scanner.nextLine();
if (command.equalsIgnoreCase("go east")) {
firstRoomEast();
...
else if (((command.equalsIgnoreCase("go north")) || (command.equalsIgnoreCase("use
key"))) && (a == true)) {
secondRoomStart();
}
else if (((command.equalsIgnoreCase("go north")) || (command.equalsIgnoreCase("use
...
+ "\nThe smell of lavender essential oils assaults your nose before you're out of
the doorframe."
+ "\nIn the west of the room lies a four-poster bed with blue curtains. Silver carpet
covers the ground."
+ "\nTo your east, there is a dresser with three drawers. In front is a door."
+ "\nYou would think this was someone's bedroom if the walls weren't covered in
large, violently cyan-colored eyeballs.");
command = scanner.nextLine();
if (command.equalsIgnoreCase("go back")) {
secondRoomStart();
}
...
System.out.println("As you approach, the east wall's eyes shift towards you."
...
+ "\nIt seems like a normal writing implement except for the U carved into its
side."
+ "\nYou got the Pencil!");
pencil = true;
...
+ "\nIt fits perfectly, and now the conglomeration vaguely resembles a key."
+ "\nYou got Key U!");
}
else {
b = false;
...
System.out.println("The door is as firmly shut as the last one was before you unlocked
it."
...
System.out.println("As you approach the bed, the sickly scent of lavender grows
stronger."
+ "\nIt seems to be wafting from the little space between the bed and the wall."
+ "\nYou might need to get the diffuser before you faint.");
command = scanner.nextLine();
...
if (!b) {
System.out.println("You tentatively reach down into the space and tug at
something on the wall."
+ "\nIt pops free with no resistance. It is not a diffuser, but a tiny purple
metal...thing."
...
+ "\nThen you slide the diffuser up the pencil."
+ "\nIt fits perfectly, and now the conglomeration looks sort of like a very
crappy key."
+ "\nYou got Key U!");
}
else {
...
+ "\nThis room is a lab of some sort. You know this because a neon sign says
LAB above you."
+ "\nThe whole area hums, and veins of green light criscross the slate-colored
walls."
+ "\nRight in front of you is a circular metal table with three squarish depressions
evenly spaced in it."
...
+ "\nRight in front of you is a circular metal table with three
depressions in it."
+ "\nYou examine your stuff. The key is too small, but the lime,
kiwi, and cube look like they'd fit."
...
if (!kiwi) {
System.out.println("There is a tree here with a single brown, hairy fruit dangling from one
of its branches.");
command = scanner.nextLine();
if (command.equalsIgnoreCase("go back")) {
thirdRoomStart();
}
else if (command.equalsIgnoreCase("get fruit") || (command.equalsIgnoreCase("get
kiwi"))) {
thirdRoomKiwiGet();
}
else if (command.equalsIgnoreCase("go north")) {
...
System.out.println("The tree is still here. Now that you look at it, it's really more
of a vine."
...
if (!lime) {
System.out.println("The air smells faintly of citrus as you approach the
tree."
...
else if ((command.equalsIgnoreCase("get fruit")) ||
(command.equalsIgnoreCase("get lime"))) {
thirdRoomLimeGet();
}
else if (command.equalsIgnoreCase("go east")) {
thirdRoomEast();
...
if (!c) {
System.out.println("The way forward is locked, as always. The keyhole is gold
this time, and rectangular."
+ "\nThere is a sign on this door. It contains the crude drawings
of:"
+ "\na fuzzy, round thing; an oval shape with pinched ends; and a
square."
+ "\nOn the floor, small enough to fit in the palm of your hand, is a
green cube.");
command = scanner.nextLine();
if (command.equalsIgnoreCase("go back")) {
thirdRoomStart();
}
else if ((command.equalsIgnoreCase("get cube")) ||
command.equalsIgnoreCase("get green cube")) {
thirdRoomCubeGet();
}
else if (command.equalsIgnoreCase("go east")) {
thirdRoomEast();
...
+ "\nThe keyhole is gold and rectangular. The sign is still there,
but you think it's served its purpose.");
command = scanner.nextLine();
if (command.equalsIgnoreCase("go back")) {
thirdRoomStart();
}
...
else if ((command.equalsIgnoreCase("use key")) ||
(command.equalsIgnoreCase("go north"))) {
finalRoomStart();
}
else if (command.equalsIgnoreCase("go south")) {
thirdRoomSouth();
...
+ "\nIt is smooth and slippery and cool, as if it were a cube-shaped hole that the
universe filled with the most generic thing possible."
+ "\nYou got the Cube!");
cube = true;
command = scanner.nextLine();
if (command.equalsIgnoreCase("go back")) {
...
System.out.println("You know the drill by now, so you don't bother jiggling the handle of
the door."
...
System.out.println("The table sinks into the ground with a metallic grinding. It leaves only
a circular seam."
+ "\nAs you begin to wonder whether you actually solved the puzzle, the grinding
starts again."
+ "\nSomething small and hard drops from the ceiling and lands on your head
with a CLINK."
...
else if ((command.equalsIgnoreCase("go east")) || (command.equalsIgnoreCase("go
west"))) {
finalRoomEastWest();
}
else {
...
+ "\nYou wonder how writing would possibly do anything.");
command = scanner.nextLine();
if (command.equalsIgnoreCase("go south")) {
finalRoomSouth();
}
...
System.out.println("You write 'USE' onto the paper. Of course it was a word scramble.
Fantastic."
+ "\nYou step back. This is exactly what you thought would happen. How
could writing things on a paper activate something?"
+ "\nAnd then you blink and the table's gone. In its place is a door. White,
with a brass knob and no keyhole."
...
System.out.println("Sure, buddy."
+ "\nI know you had to look into the internal spaghetti mess to get this,
you cheat."
+ "\nHere ya go."
